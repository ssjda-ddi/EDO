...
namespace EDO.Core.Model
{
    public static class Options
    {
        ...
        public static void Init()
        {
            ...
            collectorTypes = LoadOptions(xdoc, "CollectorTypes");
//            Dump();
        }
        ...
        public static void Dump()
        {
            ...
            Debug.WriteLine("CollectorTypes=" + collectorTypes.Count);
        ...
        public static bool IsResponseTypeUnknown(string code)
        {
            return RESPONSE_TYPE_UNKNOWN_CODE == code;
        }

        public static bool IsResponseTypeChoices(string code)
        {
            return RESPONSE_TYPE_CHOICES_CODE == code;
        }

        public static bool IsResponseTypeNumber(string code)
        {
            return RESPONSE_TYPE_NUMBER_CODE == code;
        }

        public static bool IsResponseTypeFree(string code)
        {
            return RESPONSE_TYPE_FREE_CODE == code;
        }

        public static bool IsResponseTypeDatetime(string code)
        {
            return RESPONSE_TYPE_DATETIME_CODE == code;
        }
        ...
        public static string FindResponseTypeLabel(string code)
        {
            return FindLabel(responseTypes, code);
        }
        ...
        public static Dictionary<string, string> DateTimeTypeDict
        {
            get
            {
                Dictionary<string, string> dict = new Dictionary<string, string>()
                {
                    {DATETIME_DATETIME, "DateTime"}, //YMD+HS
                    {DATETIME_DATE, "Date"}, //Date
                    {DATETIME_YEARMONTH, "YearMonth"}, //YearMonth
                    {DATETIME_YEAR, "Year"}, //Year
                    {DATETIME_DURATION, "Duration"} //Period
                };
                return dict;
            }
        }
        ...
        public static string COLLECTOR_TYPE_INDIVIDUAL = "1";
        public static string COLLECTOR_TYPE_ORGANIZATION = "2";

        private static ObservableCollection<Option> collectorTypes;
        public static ObservableCollection<Option> CollectorTypes
        {
            get
            {
