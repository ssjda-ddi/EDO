...
namespace EDO.Core.Model
{
    public class CompareRow
    {
        ...
        {
            //make sure whether Variable belonging to this line belongs to StudyUnit specified
        ...
        public List<GroupId> GetMatchIds()
        {
            ...
            {
                //Returns the ID of the first cell to be considered a match for each row(Match could not br represented only one in each line).
