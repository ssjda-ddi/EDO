...
namespace EDO.Core.IO
{
    public abstract class DocxWriter
    {
        ...
        {
            public static DocxParam CreateRightAlignParam()
            {
                DocxParam param = new DocxParam();
                param.Justification = new Justification() {Val = JustificationValues.Right};
                return param;
            }
        ...
        public class DocxTableCellParam
        {
            public string Text { get; set; }
            public DocxParam Param { get; set; }

            public TableCell CreateTableCell()
            {
                TableCell tableCell = new TableCell();
                tableCell.Append(CreateParagraph(Text, Param));
                return tableCell;
            }
        }

        public class DocxTableRowParam
        {
            private List<DocxTableCellParam> cellParams;
            public DocxTableRowParam()
            {
                cellParams = new List<DocxTableCellParam>();
            }

            public void AddRight(string text)
            {
                Add(text, DocxParam.CreateRightAlignParam());
            }

            public void Add(string text = "")
            {
                Add(text, new DocxParam());
            }

            public void Add(string text, DocxParam param)
            {
                DocxTableCellParam cellParam = new DocxTableCellParam();
                cellParam.Text = text;
                cellParam.Param = param;
            ...
            public TableRow CreateTableRow()
            {
                ...
                foreach (DocxTableCellParam cellParam in cellParams)
                {
                    tableRow.Append(cellParam.CreateTableCell());
                }
                return tableRow;
            }
        }
        ...
        public static Paragraph CreateUnderline(string content)
        {
            ...
            // No underlines are drawn in a single blank whthout setting UnderlineTrailingSpaces
            text.Text = content;
        ...
        public static Paragraph CreateBreakPageParagraph()
        {
            DocxParam param = new DocxParam()
            {
        ...
        public static Paragraph CreateMidashi1Paragraph(string text)
        {
            DocxParam param = new DocxParam()
            {
                StyleId = MIDASHI1
        ...
        public static Paragraph CreateMidashi2Paragraph(string text)
        {
            DocxParam param = new DocxParam()
            {
                StyleId = MIDASHI2
        ...
        public static Paragraph CreateParagraph(string title, DocxParam param)
        {
        ...
        public static Style GenerateGridTableStyle()
        {
        ...
        public static Style GenerateUnderlineTableStyle()
        {
        ...
        // Create the contents of styleDefinitionsPart1
        //(Copy this after loading style-applied docx file to Productivity Tool. Or applied style would be useless)
        public static void GenerateStyleDefinitionsPart1Content3(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            StyleName styleName8 = new StyleName() { Val = Resources.HeaderStyle }; //Header
            ...
            StyleName styleName10 = new StyleName() { Val = Resources.FooterStyle }; //Footer
            ...
            StyleName styleName11 = new StyleName() { Val = Resources.HeaderStyle }; //Heading1
            ...
            StyleName styleName13 = new StyleName() { Val = Resources.HeadingMap }; // Heading Map
            ...
            StyleName styleName14 = new StyleName() { Val = Resources.Heading2 }; //Heading2
        ...
        // Create the contents of documentSettingsPart1
        ...
        {
            ///// Output method of Questionnaire
            try
            {
                ...
                // Export succeeded. Would you like to view? Export completed
