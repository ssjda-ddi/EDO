...
namespace EDO.Core.IO
{
    public class DDI3IO :DDIIO
    {
        ...
        public const string TAG_VARIABLE_STATISTICS = "VariableStatistics";
        public const string TAG_TOTAL_RESPONSES = "TotalResponses";
        public const string TAG_EXCLUDED_MISSING_CATEGORY_REFERENCE = "ExcludedMissingCategoryReference";
        public const string TAG_SUMMARY_STATISTIC = "SummaryStatistic";
        public const string TAG_SUMMARY_STATISTIC_TYPE = "SummaryStatisticType";
        public const string TAG_WEIGHTED = "Weighted";
        public const string TAG_CATEGORY_STATISTICS = "CategoryStatistics";
        public const string TAG_CATEGORY_VALUE = "CategoryValue";
        public const string TAG_CATEGORY_STATISTIC = "CategoryStatistic";
        public const string TAG_CATEGORY_STATISTIC_TYPE = "CategoryStatisticType";
        public const string TAG_PROCESSING_EVENT = "ProcessingEvent";
        public const string TAG_DATA_APPRAISAL_INFORMATION = "DataAppraisalInformation";
        public const string TAG_RESPONSE_RATE = "ResponseRate";
        ...
        public const string ATTR_CODE_LIST_AGENCY = "codeListAgency";

        public const string DDI_BOOK = "Book"; //Kinds of materials
        public const string DDI_BOOK_CHAPTER = "Book Section"; //Book Title(Chapter)
        public const string DDI_TREATISE_WITH_PEER_REVIEW = "Peer Reviewed Journal Article"; //Peer-reviewed academic papers
        public const string DDI_TREATISE_WITHOUT_PEER_REVIEW = "Journal Article"; //No peer-reviewed academic papers
        public const string DDI_SOCIETY_ABSTRACT = "Conference Proceedings"; //Society Abstract
        public const string DDI_REPORT = "Report"; //Report
        public const string DDI_THESIS = "Thesis"; //Thesis
        public const string DDI_WEBPAGE = "Web Page"; //Web pages
        public const string DDI_OTHER = "Other"; //Other

        public const string DDI_MEAN = "Mean";
        public const string DDI_MEDIAN = "Median";
        public const string DDI_VALID_CASES = "ValidCases";
        public const string DDI_INVALID_CASES = "InvalidCases";
        public const string DDI_MINIMUM = "Minimum";
        public const string DDI_MAXIMUM = "Maximum";
        public const string DDI_STANDARD_DEVIATION = "StandardDeviation";
        public const string DDI_FREQUENCY = "Frequency";
        public const string DDI_PERCENT = "Percent";

        #endregion

        const string DATERANGE_SEPARATOR = ",";

        private static readonly string LABEL_FUNDING_INFO_MONEY = Resources.FundMoneyValue; //Amount

        private static readonly  string LABEL_FUNDING_INFO_TITLE = Resources.FundTitle; //Title

        private static readonly string LABEL_FUNDING_INFO_DATE_RANGE = Resources.FundPeriod; //Period
        ...
        private void AddXsd(XmlSchemaSet sc, string name)
        {
            sc.Add(null, EDOConfig.DDI31Path + name);
        }

        protected override void AddAllSchema(XmlSchemaSet sc)
        {
            AddXsd(sc, "instance.xsd");
            AddXsd(sc, "reusable.xsd");
            AddXsd(sc, "dcelements.xsd");
            AddXsd(sc, "studyunit.xsd");
            AddXsd(sc, "conceptualcomponent.xsd");
            AddXsd(sc, "datacollection.xsd");
            AddXsd(sc, "logicalproduct.xsd");
            AddXsd(sc, "physicaldataproduct.xsd");
            AddXsd(sc, "physicalinstance.xsd");
            AddXsd(sc, "archive.xsd");
            AddXsd(sc, "dcelements.xsd");
        }
