...
namespace EDO.Core.IO
{
    public class DDI2IO :DDIIO
    {
        ...
        public const string TAG_SUM_STAT = "sumStat";
        public const string TAG_CAT_STAT = "catStat";
        ...
        public const string DDI_VALD = "vald";
        public const string DDI_INVD = "invd";
        public const string DDI_FREQ = "freq";
        public const string DDI_PERCENT = "percent";
        public const string DDI_MEAN = "mean";
        public const string DDI_MEDN = "medn";
        public const string DDI_STDEV = "stdev";
        public const string DDI_MIN = "min";
        public const string DDI_MAX = "max";
        public const string DDI_Y = "Y";
        public const string DDI_N = "N";
        ...
        // Relation between EDO responseTypeCode and DDI2.5 responseDomainType
