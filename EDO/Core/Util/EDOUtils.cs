...
namespace EDO.Core.Util
{
    public static class EDOUtils
    {
        ...
        {
            //The end of the basePath should be \ in the case of directory
        ...
        /// <summary>
        /// コレクションの最初の要素を返します。コレクションが空またはnullの場合は、nullを返します。
        /// </summary>
        /// <typeparam name="T">任意の参照型</typeparam>
        /// <param name="objects">コレクション</param>
        /// <returns>Tまたはnull</returns>
        public static T FirstOrNull<T>(this Collection<T> objects) where T : class
        {
            if (objects == null || objects.Count == 0)
            {
                return null;
        ...
        /// <summary>
        /// コレクションの最後の要素を返します。コレクションが空またはnullの場合は、nullを返します。
        /// </summary>
        /// <typeparam name="T">任意の参照型</typeparam>
        /// <param name="objects">コレクション</param>
        /// <returns>Tまたはnull</returns>
        public static T LastOrNull<T>(this Collection<T> objects) where T : class
        {
            if (objects == null || objects.Count == 0)
            {
                return null;
        ...
        {
            //Cannot be deleted because it is referenced from ~
        ...
        public static string[] ParseCSV(string s, string delimiter = ",")
        {
