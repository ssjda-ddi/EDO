...
namespace EDO.VariableCategory.VariableForm
{
    ...
    {
        public static VariableVM FindFirstByQuestionId(ICollection<VariableVM> variables, string questionId)
        {
        ...
        public static List<VariableVM> FindByQuestionId(ICollection<VariableVM> variables, string questionId)
        {
            List<VariableVM> matchVariables = new List<VariableVM>();
            foreach (VariableVM variable in variables)
            {
                if (variable.QuestionId == questionId)
                {
        ...
        public static List<string> GetTitles(ICollection<VariableVM> variables)
        {
            return variables.Select(x => x.Title).ToList();
        }
        ...
        //public string GeneratorQuestionId
        //{
        //    get
        //    {
        //        return variable.GeneratorQuestionId; 
        //    }
        //    set
        //    {
        //        if (variable.GeneratorQuestionId != value)
        //        {
        //            variable.GeneratorQuestionId = value;
        //            NotifyPropertyChanged("GeneratorQuestionId");
        //        }
        //    }
        //}
        ...
        public string ConceptTitle
        {
            get
            {
                return StudyUnit.FindConceptTitle(ConceptId);
            }
        }
        ...
        public string QuestionTitle
        {
            get
            {
                return StudyUnit.FindQuestionTitle(QuestionId);
            }
        }
        ...
        public string UniverseTitle
        {
            get
            {
                return StudyUnit.FindUniverseTitle(UniverseId);
            }
        }
