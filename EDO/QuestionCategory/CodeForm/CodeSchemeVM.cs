...
namespace EDO.QuestionCategory.CodeForm
{
    ...
    {
        public static CodeSchemeVM Find(ICollection<CodeSchemeVM> codeSchemes, string codeSchemeId)
        {
        ...
        public static CodeVM FindCodeByCategoryId(ICollection<CodeSchemeVM> codeSchemes, string categoryId)
        {
            foreach (CodeSchemeVM codeScheme in codeSchemes)
            {
        ...
        public string Title
        {
            ...
            set
            {
                if (codeScheme.Title != value)
                {
                    ...
                    {
                        value = Resources.UntitledCodeScheme; //Unnamed Code Scheme
                    }
