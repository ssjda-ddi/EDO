...
{
    public class CodeVM :BaseVM, IEditableObject, ICode
    {
        ...
        public static CodeVM FindByValue(ICollection<CodeVM> codes, string value)
        {
            foreach (CodeVM code in codes)
            {
                if (code.Value == value)
        ...
        private string bakLabel; //For back-up
