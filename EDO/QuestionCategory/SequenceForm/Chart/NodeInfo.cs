...
namespace EDO.QuestionCategory.SequenceForm.Chart
{
    ...
    public class NodeInfo
    {
        ...
        public int RightIncomingCount { get; set; } //used when re-sizing
        public int RightIncomingIndex { get; set; } //to use when creating a shape
        ...
        public double ContainerHeight { get; set; } //Height of diamonds
