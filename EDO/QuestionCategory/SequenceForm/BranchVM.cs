...
{
    // corresponds to each of IF, ELSE IF and ELSE
    public class BranchVM : BaseVM
    {
        ...
        public void ForceUpdateThenConstructNo(string no)
        {
            thenConstructNo = no;
        }
        ...
        public override string this[string columnName]
        {
            get
            {
                ...
                if (columnName == "ThenConstructNo")
                {
                    ...
                    {
                        return Resources.SelectQuestionOrSentence; //Select Question Item or Statement
                    }
                }
                return null;
            }
