...
namespace EDO.StudyCategory.MemberForm
{
    public class MemberVM :BaseVM, IEditableObject
    {
        ...
        public static List<MemberVM> FindByOrganizationId(ObservableCollection<MemberVM> members, string organizationId)
        {
            List<MemberVM> foundMembers = new List<MemberVM>();
            foreach (MemberVM member in members)
            {
        ...
        public static MemberVM FindByNames(ObservableCollection<MemberVM> members, string lastName, string firstName, string organizationName, string position)
        {
...
//            bakRole = role == null ? null : role.Clone() as Option;
        ...
        public void CancelEdit()
        {
            ...
            this.RoleName = bakMember.RoleName;
